...
int __init init_module(void)
{
    ...
    //reg = ioread32((void __iomem*)AST_SCU_VA_BASE + 0x7c);//ASD STRAP[22] disable -> GPIOE5 
    reg = 0x00400000; 		
    iowrite32(reg, (void __iomem*)AST_SCU_VA_BASE + 0x7c);   

    reg = ioread32((void __iomem*)AST_GPIO_VA_BASE + 0x1e4);//ASD CPU_PWRGD(I)(Z1), CPU_PREQ(O)(AA4), TCK_MUX_SEL(O)(AA5)
    reg |= 0x00300000;
    reg &= 0xFFFFFFFE;
    iowrite32(reg, (void __iomem*)AST_GPIO_VA_BASE + 0x1e4);
    ...
    reg = ioread32((void __iomem*)AST_GPIO_VA_BASE + 0x24); // ASD DEGBUG_EN(O)(E5), PLTRST(I)(F6), CPU_PRDY(I)(F7), XDP_PRESENT(I)(E4)
    reg &= 0xFFFF3FEF;                                   
    reg |= 0x00000020;
    iowrite32(reg, (void __iomem*)AST_GPIO_VA_BASE + 0x24);  
